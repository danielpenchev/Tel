...
public class AssertionsHomework
{
        ...
        where T : IComparable<T>
    {
        ...
        var index = BinarySearch(collectionToSearch, value, 0, collectionToSearch.Length);

        Debug.Assert(index < collectionToSearch.Length, "index is larger than array size.");
        ...
        where T : IComparable<T>
    {
        while (startIndex <= endIndex)
        {
            ...
            Debug.Assert(endIndex < collectionToSearch.Length, "endIndex is larger than array size.");
