...
namespace Students.Entities
{
    public class Course
    {
        ...
        public void AddStudent(Student student)
        {
            ...
            {
                throw new InvalidOperationException("This student already has joinet the course.");
            }
        ...
        public void RemoveStudent(Student student)
        {
            ...
            if(!this.students.Contains(student))
            {
                throw new InvalidOperationException("The student does not attend in this course.");
            }
