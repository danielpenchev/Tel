namespace Students.Entities
{
    ...
    public class SchoolClass
    {
        ...
        public void AddStudent(Student student)
        {
            ...
            {
                throw new ArgumentException("There is already a student with the same unique number.");
            }
        ...
        public void RemoveStudent(Student student)
        {
            if(student == null)
            {
                throw new ArgumentNullException("student", "Student cannot be null or empty.");
            }
