...
namespace Methods.OtherInfo
{
    public class PersonalInformation : IPersonalInformation
    {
        ...
        {
            var result = !characteristics.Any() ? "not available" : string.Join(", ", this.characteristics);
        ...
        private void ParseInputInfo(string info)
        {
            ...
            {
                throw new ArgumentException("Personal information string must contain birth date.");
            }
        }
        ...
        private void HandleBirdhDateCommand(string date)
        {
            DateTime birthDate;
        ...
        private IDictionary<string, Action<string>> BuildHandlersDictionary()
        {
            var dictionary = new Dictionary<string, Action<string>>()
            {
                ...
                { PersonalInformation.BirthDateCommand, this.HandleBirdhDateCommand },
